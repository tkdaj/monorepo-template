export type Primitive = number | string | boolean | null | undefined | bigint | symbol;

export type POJO = Record<PropertyKey, unknown>;
export type EmptyPOJO = Record<PropertyKey, never>;

export type PartialPick<Obj, Key extends keyof Obj> = Omit<Obj, Key> & Partial<Pick<Obj, Key>>;
export type RequiredPick<Obj, Key extends keyof Obj> = Omit<Obj, Key> & Required<Pick<Obj, Key>>;
 ...
 */
export type Nullable<Val = void> = Val extends void ? null | undefined : Val | null | undefined;
